...
Database và Docker cho phần Chính Đức (task 21–54): [hướng dẫn chạy](database/README.md), [đối chiếu 34 task](docs/chinh-duc-task-21-54.md), [quy tắc dữ liệu](docs/chinh-duc-data-contracts.md).
