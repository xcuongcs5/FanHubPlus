...
public sealed class OutboxPublisher(IServiceScopeFactory scopes, ILogger<OutboxPublisher> logger) : BackgroundService
{
    ...
    {
        [nameof(EventChangedEvent)] = typeof(EventChangedEvent),
        [nameof(EventSubmittedForReviewEvent)] = typeof(EventSubmittedForReviewEvent),
        [nameof(EventStaffChangedEvent)] = typeof(EventStaffChangedEvent)
    };
